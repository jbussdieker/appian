class DeploymentsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @deployment.save
        TerraformApplyWorker.perform_async(@deployment.id)
  ...
  def destroy
    #@deployment.destroy
    TerraformApplyWorker.perform_async(@deployment.id, true)
    respond_to do |format|
  ...
  private
    ...
    def deployment_params
      params.require(:deployment).permit(:name, :project_id, :variables, :output, :status, :state)
    end
end
